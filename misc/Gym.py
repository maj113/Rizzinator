...
def gymExcercise():
    ...
    print(f"Your current jacked stat is {player_stats[1]}, and {money[0]}$")
    ...
    if excerciseTime > 20:
        ...
        money[0] = money[0] - (excerciseTime*2)
        for l in range(excerciseTime):
            print("💪 ", flush = True,end="")
            sleep(1)
        print()
        slow_print(f"\nyou got closer to being an absolute CHAD, good work chap. You now have {money[0]}$. But it was worth it, and your new stats are\n")
