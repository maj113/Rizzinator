...
from mainmenu import slow_print
...
def goingToShop():
    ...
    if perfume_picked == "challen":
        ...
        sleep(1)
        player_stats[2] = player_stats[2] + 1
        slow_print("\nYou took a look at the Juzza bottle and asked arround if anyone knew what the hell Juzza is. Much to your dissapointment no one knew what it was and the cashier said it isn't even in their inventory. Nevertheless you now smell like raspberies and creampie.", player_stats[2])
